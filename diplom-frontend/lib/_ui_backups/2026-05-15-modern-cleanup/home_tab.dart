  ...
  Future<void> _load() async {
    ...
    try {
      final results = await Future.wait([
        ...
        api.getMatchCandidates().catchError((_) => <String, dynamic>{}),
      ...
      final matchData = results[13] as Map<String, dynamic>? ?? const {};
      final people = (matchData['candidates'] as List?) ?? [];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: mood.glowColor.withOpacity(0.24),
              blurRadius: 20,
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      mood.gradient.colors.first.withOpacity(0.42),
