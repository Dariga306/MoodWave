          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 10,
                crossAxisSpacing: 10,
                childAspectRatio: 1.55, // широкие карточки как у жанров
              ),
            ),
          ),
        ],
                  ...
                  children: [
                    CachedNetworkImage(
                      ...
                      placeholder: (_, __) => Container(
                        color: mood.gradient.colors.first,
                      ),
                    ...
                    Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            Colors.black.withOpacity(0.08),
                            mood.gradient.colors.first.withOpacity(0.40),
                            mood.gradient.colors.last.withOpacity(0.84),
                          ],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
