  ...
  Future<void> _load() async {
    ...
    try {
      final results = await Future.wait([
        ...
        api.getRecentlyPlayed(limit: 10).catchError((_) => <dynamic>[]),
      ...
      setState(() {
        ...
        _recentlyPlayed = (results[3] as List?) ?? [];
        _freshWave = (results[4] as List?) ?? [];
        _loading = false;
      });
    } catch (_) {
      if (!mounted) return;
              ...
              if (_recentlyPlayed.isNotEmpty) ...[
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: _recentlyPlayed.length.clamp(0, 10),
                    itemBuilder: (context, i) {
                      final track =
                          _recentlyPlayed[i] as Map<String, dynamic>;
                      return _RecentItem(track: track);
                    },
                  ),
                ),
              ],
              ...
              if (_recommendations.isNotEmpty) ...[
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      final track =
                          _recommendations[i] as Map<String, dynamic>;
...
class _RecentItem extends StatelessWidget {
  ...
  const _RecentItem({required this.track});
